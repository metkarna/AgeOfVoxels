...
namespace DevelopmentTestServer {
	public static class Startup {
		...
		static void Main() {
			...
			//
			//PlayerIO.DevelopmentServer.Server.StartWithDebugging("ageofvoxels-rngqg9j7r06969qdooho7w", "public", new Dictionary<string, string>() { { "userId", "bob" } }, null, "FridgeMagnets", null, null, 30000);
